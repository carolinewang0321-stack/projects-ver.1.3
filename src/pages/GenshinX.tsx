  ...
  return (
    <PageShell back="/" title="《原神》日本社媒（X）分析小结" sub="GENSHIN JP X · 日本市场社媒运营分析">
      ...
      <section className="section gx-sec">
        ...
        <p className="reveal">
          从内容表现来看，CV公布、新角色/剧情介绍、版本及活动预告是最核心的内容支柱；其中CV公布和角色/剧情类内容的平均浏览量、平均转发量明显高于YouTube同步帖等纯分发型内容。声优/CV发表类内容的平均浏览量和转发量都是所有类型里最高的，这符合日本二次元受众的普遍规律，声优粉丝和角色粉丝是重叠但独立的两个圈子，一个声优官宣会同时触发角色粉+声优粉两波转发，传播链比单纯的角色生日画长。另外"CV发表"是密集连发（6/26一天发了12条），形成刷屏效应，算法会因为短时间内的互动密度给更多曝光。
        </p>
        <p className="reveal">
          运营发文常把"詳細はこちら"等YouTube外链放评论区而不是原帖，这是X运营的常见操作，逻辑是：X的算法对外链（outbound link）的原生推文会降低曝光（因为平台不想用户跳出站外），所以官号把纯宣传图/视频放在主推文冲曝光，把跳转链接（hoyolab详情页）放在自己回复自己的楼层里，不影响主帖的分发权重。从美观程度上看，这样主帖看起来更"干净"、更适合被转发，提升转发率。从数据看，这些"详情链接"贴文的互动量明显低于主贴（比如声优发表系列里那些"詳細はこちら"贴文互动量只是主贴的1/10不到），说明用户确实不太点开评论楼层的补充链接，但官号仍然坚持这么发，是为了保护主贴的算法权重。
        </p>
      </section>
      ...
      <section className="section gx-sec">
        ...
        <p className="reveal">
          文案：【Ver.7.1報酬一覧】原神Ver.7.1「冥府へのレクイエム」が9月23日にリリース！🎁★5キャラクター2名を招待可能！さらに、紡がれた運命×10、原石×1,600、「創世結晶」の初回チャージ2倍ボーナスのリセットなど、盛りだくさんのプレゼントが待っています！
        </p>
        <p className="reveal">
